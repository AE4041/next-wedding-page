        ...
        <div className="md:py-24 bg-[#622B14] py-0">
            <div className="max-w-5xl mx-auto px-4 py-10">
                <div className="text-center mb-16 animate-fade-in">
                    <h2 className="font-script text-5xl md:text-6xl mb-2 text-[#C08552]">Wedding Schedule</h2>
                    ...
                    <div className="hidden md:block">
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="font-serif text-base lg:text-lg text-white mb-1 leading-tight">Arrival of Guests</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="talic text-wedding-text/70 leading-relaxed text-white mb-1">Opening Remarks & Welcome</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="font-serif text-base lg:text-lg text-white mb-1 leading-tight">Marriage Discourse</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="font-serif text-base lg:text-lg text-white mb-1 leading-tight">Photo Session</h3>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex items-start gap-4 pl-1 animate-fade-in">
                                    ...
                                    <div className="flex-1 pt-1">
                                        <div className="flex items-baseline gap-3 mb-0.5">
                                            <span className="bg-[#C08552] text-[#C08552] px-2 py-0.5 rounded text-xs font-medium">11:00 AM</span>
                                            <h3 className="font-serif text-lg text-white">Arrival of Guests</h3>
                                        </div>
                                        <p className="text-white/60 text-sm">Accueil et bienvenue</p>
                                    </div>
                                </div>
