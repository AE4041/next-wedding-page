        ...
        <div className="md:py-24 bg-[#622B14] py-0">
            <div className="max-w-5xl mx-auto px-4 py-10">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-[#F3E4C9]/80  tracking-wide">What we have prepared for you</p>
                </div>
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <div className="w-14 h-14 rounded-full bg-[#C08552] border-2 border-white/30 flex items-center justify-center text-wedding-gold mb-4 shadow-sm group-hover:border-[#E4D6A9] group-hover:scale-110 transition-all duration-300 z-10">
                                    <Icon icon="solar:user-bold-duotone" className="w-6 h-6 text-amber-800" />
                                </div>
                                <h3 className="text-base lg:text-lg text-[#F3E4C9]/80  mb-1 leading-tight">Arrival of Guests</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="text-wedding-text/70 leading-relaxed text-[#F3E4C9]/80  mb-1">Opening Remarks & Welcome</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="text-base lg:text-lg text-[#F3E4C9]/80  mb-1 leading-tight">Marriage Discourse</h3>
                            </div>
                            ...
                            <div className="flex flex-col items-center text-center group animate-fade-in">
                                ...
                                <h3 className="text-base lg:text-lg text-[#F3E4C9]/80  mb-1 leading-tight">Photo Session</h3>
                            </div>
                        </div>
                    </div>
                    <div className="relative md:hidden">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 pl-1 animate-fade-in">
                                <div className="w-11 h-11 rounded-full bg-[#C08552] border-2 border-white/30 flex items-center justify-center text-wedding-gold shrink-0 shadow-sm z-10">
                                    <Icon icon="solar:user-bold-duotone" className="w-6 h-6 text-amber-800" />
                                </div>
                                <div className="flex-1 pt-1">
                                    ...
                                    <h3 className="text-base text-[#F3E4C9]/80 /80">Arrival of Guests</h3>
                                </div>
                            </div>

                            <div className="flex items-start gap-4 pl-1 animate-fade-in">
                                <div className="w-11 h-11 rounded-full bg-[#C08552] border-2 border-white/30 flex items-center justify-center text-wedding-gold shrink-0 shadow-sm z-10">
                                    <Icon icon="twemoji:handshake-medium-skin-tone-light-skin-tone" className="w-6 h-6 text-amber-800" />
                                </div>
                                <div className="flex-1 pt-1">
                                    <div className="flex items-baseline gap-3 mb-0.5">
                            ...
                            <div className="flex items-start gap-4 pl-1 animate-fade-in">
                                <div className="w-11 h-11 rounded-full bg-[#C08552] border-2 border-white/30 flex items-center justify-center text-wedding-gold shrink-0 shadow-sm z-10">
                                    <Icon icon="noto:ring" className="w-5 h-5 text-amber-800" />
                                </div>
                                <div className="flex-1 pt-1">
                                    <div className="flex items-baseline gap-3 mb-0.5">
                            ...
                            <div className="flex items-start gap-4 pl-1 animate-fade-in">
                                <div className="w-11 h-11 rounded-full bg-[#C08552] border-2 border-white/30 flex items-center justify-center text-wedding-gold shrink-0 shadow-sm z-10">
                                    <Icon icon="lets-icons:camera-duotone" className="w-6 h-6 text-amber-800" />
                                </div>
                                <div className="flex-1 pt-1">
                                    <div className="flex items-baseline gap-3 mb-0.5">
